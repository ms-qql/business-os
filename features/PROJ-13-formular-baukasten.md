...
**Deployed:** 2026-08-24 · **Version:** 0.1.14 · **Host:** Dokploy (Compose), Auto-Deploy via Push auf `main`.

**Ausgeliefert:** vereinfachte Kachel-Optionen mit automatisch erzeugtem Wert, verständliche API-Fehler, das Löschen nie veröffentlichter Entwürfe, benannte Schritte, verzögerte Optionswarnungen und öffentliche Formularlinks über die aktive Betriebsdomain.
