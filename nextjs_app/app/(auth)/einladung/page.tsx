...
export default function EinladungPageWrapper() {
  return (
    <Suspense>
      <EinladungPage />
    </Suspense>
...
function EinladungPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setInfo("Passwort gesetzt. Sie werden zur Anmeldung weitergeleitet …");
      setTimeout(() => router.push("/login"), 1500);
    } catch (err) {
      setError(err instanceof ApiError ? err.message : "Einladung konnte nicht eingelöst werden.");
    } finally {
      setPending(false);
    }
  }
    ...
    <div className="flex min-h-screen items-center justify-center bg-[var(--color-background)] p-4">
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription>Legen Sie Ihr Passwort für Ihr neues Konto fest.</CardDescription>
        </CardHeader>
        <CardContent>
